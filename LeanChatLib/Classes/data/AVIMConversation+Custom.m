...
//        id <CDUserModel> user = [[CDChatManager manager].userDelegate getUserById:[userIds objectAtIndex:i]];
        UserItem * item = [[FMDBManager sharedManager] getAllNicknameAndImageUrl:[userIds objectAtIndex:i]];
        
        [names addObject:item.nickname];
    }
...
//        id <CDUserModel> other = [[CDChatManager manager].userDelegate getUserById:otherId];
        UserItem * other = [[FMDBManager sharedManager] getAllNicknameAndImageUrl:otherId];

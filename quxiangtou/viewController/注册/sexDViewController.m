...
@interface sexDViewController ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation sexDViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    _array2 = @[@"未填写",@"我爱同性",@"我爱异性",@"我男女都爱"];
    [self createNav];
    [self loadTableView];
...
{
    static NSString *reuse=@"sexDirestory";
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    if ([_delegate respondsToSelector:@selector(setSexDeString:)]) {
        [_delegate setSexDeString:[_array2 objectAtIndex:indexPath.row]];
    }

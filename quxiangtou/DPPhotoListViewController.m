...
-(void)createNavigationBar
{
    ...
    button2.frame = CGRectMake(Screen_width - 40, 25, 35, 35);
    [button2 setTitle:@"取消" forState:UIControlStateNormal];
    [button2 addTarget:self action:@selector(clickBack) forControlEvents:UIControlEventTouchUpInside];
    [navigationView addSubview:button2];
